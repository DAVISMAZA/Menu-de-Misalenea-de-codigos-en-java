...
public class MenuPrincipal {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("18. Contador de Números (Positivos/Negativos/Ceros en Array)");
            ...
            System.out.println("21. Juego de Adivinanza (Versión 2)");
            System.out.println("22. Número Misterioso (Juego con Intentos)");
            System.out.println("23. Números Capicúa en un Rango");
            System.out.println("24. Cálculo de Área y Perímetro de Rectángulo");
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 0:
                        ...
                        break;
                    default:
                        System.out.println("Opción no válida. Por favor, ingresa un número del 0 al 28.");
                        break;
                }
                System.out.println("------------------------------------");
                ...
                System.out.println("Ocurrió un error al ejecutar el programa. Asegúrate de que todos los archivos .java estén en la misma carpeta y compilados.");
